...
function agendarBroadcastsLancamento() {
  ...
  var planos = [
    ...
    ['L3B', '⚡ 20% OFF só até meia-noite',                          'broadcasts/lancamento/L3B-abertura-carrinho.html', TODOS, new Date(2026, 7, 4, 21, 30)],
    ['L3C', '⚡ 10% OFF só até meia-noite',                          'broadcasts/lancamento/L3C-desconto-10.html',   TODOS, new Date(2026, 7, 5, 21, 30)],
    ['L3D', 'Lançamento oficial — preço Fundador até 16/08',        'broadcasts/lancamento/L3D-lancamento-oficial.html', TODOS, new Date(2026, 7, 6, 21, 30)],
